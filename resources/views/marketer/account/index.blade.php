    ...
    <div class="form-group">
        <div class="col-sm-offset-3 col-sm-6">
            <div id="imagePreview" class="user-image"
                 style="background-image: url( {{ url('images/marketers/' . $marketer->user()->avatar)}} );"></div>
        </div>
    </div>

    @if($marketer->user()->avatar != 'user.png')
        <a href="{{ url('marketer/account-details/remove-avatar') }}"> Remove avatar </a>
    @endif
